...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.20' && document.querySelector('.brand small').textContent==='2.3.20'", "true", js(scenario, "PizzaScan.version==='2.3.20' && document.querySelector('.brand small').textContent==='2.3.20'"));
            assertEquals("JS check: window.PizzaScanDiscovery55?.build===55 && PizzaScanDiscovery55.viewportBBox===true && PizzaScanDiscovery55.exactSelectorFamilies===20 && PizzaScanDiscovery55.trattoriaSearch===true && PizzaScanDiscovery55.stableElementCenters===true && PizzaScanDiscovery55.nominatimSearch===true && PizzaScanDiscovery55.photonDiscovery===false && PizzaScanDiscovery55.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery55?.build===55 && PizzaScanDiscovery55.viewportBBox===true && PizzaScanDiscovery55.exactSelectorFamilies===20 && PizzaScanDiscovery55.trattoriaSearch===true && PizzaScanDiscovery55.stableElementCenters===true && PizzaScanDiscovery55.nominatimSearch===true && PizzaScanDiscovery55.photonDiscovery===false && PizzaScanDiscovery55.slimToolbar===false"));
