...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("true", js(scenario, "PizzaScan.version==='2.3.11' && document.querySelector('.brand small').textContent==='2.3.11'"));
            assertEquals("true", js(scenario, "window.PizzaScanDiscovery46?.build===46 && PizzaScanDiscovery46.defaultViewport===true && PizzaScanDiscovery46.queryHitsAuthoritative===true && PizzaScanDiscovery46.genericRestaurantsVisible===false && PizzaScanDiscovery46.emptyProvidersFailFast===true"));
