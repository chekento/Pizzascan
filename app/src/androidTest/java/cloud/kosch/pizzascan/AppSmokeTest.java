...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.21' && document.querySelector('.brand small').textContent==='2.3.21'", "true", js(scenario, "PizzaScan.version==='2.3.21' && document.querySelector('.brand small').textContent==='2.3.21'"));
            assertEquals("JS check: window.PizzaScanDiscovery56?.build===56 && PizzaScanDiscovery56.viewportBBox===true && PizzaScanDiscovery56.exactSelectorFamilies===20 && PizzaScanDiscovery56.trattoriaSearch===true && PizzaScanDiscovery56.stableElementCenters===true && PizzaScanDiscovery56.nominatimSearch===true && PizzaScanDiscovery56.photonDiscovery===false && PizzaScanDiscovery56.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery56?.build===56 && PizzaScanDiscovery56.viewportBBox===true && PizzaScanDiscovery56.exactSelectorFamilies===20 && PizzaScanDiscovery56.trattoriaSearch===true && PizzaScanDiscovery56.stableElementCenters===true && PizzaScanDiscovery56.nominatimSearch===true && PizzaScanDiscovery56.photonDiscovery===false && PizzaScanDiscovery56.slimToolbar===false"));
