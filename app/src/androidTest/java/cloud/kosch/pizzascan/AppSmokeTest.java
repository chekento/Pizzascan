...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("true", js(scenario, "document.querySelector('#build40-tools[data-build44=true]')!==null && [...document.querySelectorAll('#build40-tools .build44-mini-tool')].every(b=>b.getBoundingClientRect().height<=36) && document.getElementById('map-refresh').textContent.trim()==='Hier suchen'"));
