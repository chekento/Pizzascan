...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.18' && document.querySelector('.brand small').textContent==='2.3.18'", "true", js(scenario, "PizzaScan.version==='2.3.18' && document.querySelector('.brand small').textContent==='2.3.18'"));
            assertEquals("JS check: window.PizzaScanDiscovery53?.build===53 && PizzaScanDiscovery53.viewportBBox===true && PizzaScanDiscovery53.exactSelectorFamilies===20 && PizzaScanDiscovery53.trattoriaSearch===true && PizzaScanDiscovery53.stableElementCenters===true && PizzaScanDiscovery53.nominatimSearch===true && PizzaScanDiscovery53.photonDiscovery===false && PizzaScanDiscovery53.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery53?.build===53 && PizzaScanDiscovery53.viewportBBox===true && PizzaScanDiscovery53.exactSelectorFamilies===20 && PizzaScanDiscovery53.trattoriaSearch===true && PizzaScanDiscovery53.stableElementCenters===true && PizzaScanDiscovery53.nominatimSearch===true && PizzaScanDiscovery53.photonDiscovery===false && PizzaScanDiscovery53.slimToolbar===false"));
