...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("true", js(scenario, "PizzaScan.version==='2.3.10' && document.querySelector('.brand small').textContent==='2.3.10'"));
            assertEquals("true", js(scenario, "window.PizzaScanDiscovery45?.build===45 && PizzaScanDiscovery45.defaultViewport===true && PizzaScanDiscovery45.queryHitsAuthoritative===true && PizzaScanDiscovery45.genericRestaurantsVisible===false"));
