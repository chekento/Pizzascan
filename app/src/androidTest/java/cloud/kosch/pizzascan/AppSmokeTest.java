...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.17' && document.querySelector('.brand small').textContent==='2.3.17'", "true", js(scenario, "PizzaScan.version==='2.3.17' && document.querySelector('.brand small').textContent==='2.3.17'"));
            assertEquals("JS check: window.PizzaScanDiscovery52?.build===52 && PizzaScanDiscovery52.viewportBBox===true && PizzaScanDiscovery52.exactSelectorFamilies===20 && PizzaScanDiscovery52.trattoriaSearch===true && PizzaScanDiscovery52.stableElementCenters===true && PizzaScanDiscovery52.nominatimSearch===true && PizzaScanDiscovery52.photonDiscovery===false && PizzaScanDiscovery52.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery52?.build===52 && PizzaScanDiscovery52.viewportBBox===true && PizzaScanDiscovery52.exactSelectorFamilies===20 && PizzaScanDiscovery52.trattoriaSearch===true && PizzaScanDiscovery52.stableElementCenters===true && PizzaScanDiscovery52.nominatimSearch===true && PizzaScanDiscovery52.photonDiscovery===false && PizzaScanDiscovery52.slimToolbar===false"));
