...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.19' && document.querySelector('.brand small').textContent==='2.3.19'", "true", js(scenario, "PizzaScan.version==='2.3.19' && document.querySelector('.brand small').textContent==='2.3.19'"));
            assertEquals("JS check: window.PizzaScanDiscovery54?.build===54 && PizzaScanDiscovery54.viewportBBox===true && PizzaScanDiscovery54.exactSelectorFamilies===20 && PizzaScanDiscovery54.trattoriaSearch===true && PizzaScanDiscovery54.stableElementCenters===true && PizzaScanDiscovery54.nominatimSearch===true && PizzaScanDiscovery54.photonDiscovery===false && PizzaScanDiscovery54.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery54?.build===53 && PizzaScanDiscovery54.viewportBBox===true && PizzaScanDiscovery54.exactSelectorFamilies===20 && PizzaScanDiscovery54.trattoriaSearch===true && PizzaScanDiscovery54.stableElementCenters===true && PizzaScanDiscovery54.nominatimSearch===true && PizzaScanDiscovery54.photonDiscovery===false && PizzaScanDiscovery54.slimToolbar===false"));
