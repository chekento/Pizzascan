...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.23' && document.querySelector('.brand small').textContent==='2.3.23'", "true", js(scenario, "PizzaScan.version==='2.3.23' && document.querySelector('.brand small').textContent==='2.3.23'"));
