...
public class AppSmokeTest {
    ...
    @Test public void ratingsAndCompactNavigationAreInTheInstalledApk() throws Exception {
        try (ActivityScenario<MainActivity> scenario = ActivityScenario.launch(MainActivity.class)) {
            ...
            assertEquals("JS check: PizzaScan.version==='2.3.22' && document.querySelector('.brand small').textContent==='2.3.22'", "true", js(scenario, "PizzaScan.version==='2.3.22' && document.querySelector('.brand small').textContent==='2.3.22'"));
            assertEquals("JS check: window.PizzaScanDiscovery57?.build===57 && PizzaScanDiscovery57.viewportBBox===true && PizzaScanDiscovery57.exactSelectorFamilies===20 && PizzaScanDiscovery57.trattoriaSearch===true && PizzaScanDiscovery57.stableElementCenters===true && PizzaScanDiscovery57.nominatimSearch===true && PizzaScanDiscovery57.photonDiscovery===false && PizzaScanDiscovery57.slimToolbar===false", "true", js(scenario, "window.PizzaScanDiscovery57?.build===57 && PizzaScanDiscovery57.viewportBBox===true && PizzaScanDiscovery57.exactSelectorFamilies===20 && PizzaScanDiscovery57.trattoriaSearch===true && PizzaScanDiscovery57.stableElementCenters===true && PizzaScanDiscovery57.nominatimSearch===true && PizzaScanDiscovery57.photonDiscovery===false && PizzaScanDiscovery57.slimToolbar===false"));
