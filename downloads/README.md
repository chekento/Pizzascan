...
Die GitHub-Direkt-APK ist installierbar signiert. Eine spätere Google-Play-Ausgabe kann eine andere Release-Signatur verwenden. Android erlaubt dann möglicherweise kein direktes Update über die GitHub-APK; in diesem Fall ist eine Neuinstallation erforderlich.
...
Für 2.3.4 ist [SHA256SUMS-2.3.4.txt](SHA256SUMS-2.3.4.txt) maßgeblich. Die Datei wird vom erfolgreichen CI-Publish zusammen mit `PizzaScan-2.3.4.apk` aktualisiert.
