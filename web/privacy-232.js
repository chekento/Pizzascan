/* PizzaScan 2.3.2 privacy supplement: keep localized in-app privacy aligned with the shipped search fallback. */
(function(root){
'use strict';
const previous=root.showPrivacy;
if(typeof previous!=='function'||previous.__privacy232)return;
const text={
 en:{
  date:'Updated: 14 September 2026 · Version 2.3.2 · Android package cloud.kosch.pizzascan',
  title:'Nominatim fallback in version 2.3.2',
 ...
 it:{
  date:'Aggiornata: 14 settembre 2026 · Versione 2.3.2 · Pacchetto Android cloud.kosch.pizzascan',
  title:'Fallback Nominatim nella versione 2.3.2',
 ...
 es:{
  date:'Actualizada: 14 de septiembre de 2026 · Versión 2.3.2 · Paquete Android cloud.kosch.pizzascan',
  title:'Fallback de Nominatim en la versión 2.3.2',
 ...
 fr:{
  date:'Mise à jour : 14 septembre 2026 · Version 2.3.2 · Package Android cloud.kosch.pizzascan',
  title:'Repli Nominatim dans la version 2.3.2',
...
async function showPrivacy232(){
 ...
 if(!copy||!article||article.querySelector('[data-privacy-232]'))return;
 const hint=article.querySelector('.hint');
 if(hint)hint.textContent=copy.date;
 const section=document.createElement('section');
 section.dataset.privacy232='true';
 ...
 const providers=document.createElement('p');providers.dataset.privacy232='providers';
...
showPrivacy232.__privacy232=true;
