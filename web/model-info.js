 ...
 function html(model){
  return `<div class="model-explanation">
   ...
   <details><summary>Was funktioniert anschließend offline?</summary>
    <p>Nach einem vollständig abgeschlossenen Download funktioniert die Fotobewertung auch ohne Internet, solange die Modelldateien gespeichert bleiben. In der Android-App liegen sie im privaten dauerhaften App-Speicher. Ein Wechsel zu einem bisher ungenutzten Modell erfordert einen weiteren Download mit eigener Bestätigung. Ein vorhandenes Modell wird wiederverwendet.</p>
    <p>Normales Leeren des Android-Caches entfernt die dauerhaft gespeicherten Modelle nicht. Ein neuer Download wird nötig, wenn du die Modelle ausdrücklich entfernst, die App-Daten löschst oder PizzaScan deinstallierst. Im Browser kann die Speicherbereinigung dagegen Modelldateien entfernen. Unter Einstellungen → Foto-KI → „Heruntergeladene Modelle entfernen“ kannst du die Modelldateien und ihre Downloadfreigaben löschen. Deine gespeicherten Fotos und Bewertungen bleiben dabei erhalten.</p>
    <p>„Offline“ bezieht sich auf die Fotoanalyse. Neue Kartenkacheln, Restaurantsuche, aktuelle Ortsdaten und Google Maps benötigen weiterhin eine Internetverbindung. PizzaScan wechselt bei einem KI-Fehler nicht automatisch zu einer Cloud-Analyse.</p>
   </details>
   <details><summary>Datenschutz und Grenzen im Detail</summary>
    <p>Beim Modell-Download erhalten Hugging Face und seine Auslieferungsserver technisch notwendige Verbindungsdaten wie deine IP-Adresse und die angefragten Modelldateien. Dein Foto und deine Bewertung werden für die Analyse nicht mitgesendet. Fotos und Ergebnisse bleiben in PizzaScan lokal gespeichert, bis du sie löschst oder bewusst exportierst bzw. teilst. Kopieren und Teilen erfolgen nur auf deine ausdrückliche Aktion.</p>
