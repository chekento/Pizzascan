# Datensicherheit – Arbeitsblatt für PizzaScan 2.3.0
...
| Suchverlauf innerhalb der App | Orts-/Restaurantbegriffe für verzögerte Suchvorschläge und beim Absenden an Photon, einschließlich Suchmittelpunkt. Lokaler Suchcache. | Erhoben und weitergegeben; optional, Funktionalität. Auch Online-Vorschläge nach kurzer Eingabepause berücksichtigen. |
| Geräte- oder andere IDs / technische Verbindungsdaten | IP-Adresse und App-/Browserkennung an Karten-, Bewertungs- und Downloadanbieter; keine Werbe-ID, kein eigener stabiler Tracking-Identifier. | Konservativ als erhoben/weitergegeben für Funktionalität angeben; bei Online-Kartennutzung technisch erforderlich. Keine Anonymität zusagen. |
