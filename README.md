...
<h1 align="center">PizzaScan 2.3.20 · Build 55</h1>
...
**Neu in 2.3.20:** Die Suche startet nach der Standortfreigabe automatisch und bleibt auch nach Kartenbewegungen aktiv; das Suchsymbol zeigt den laufenden Abruf animiert an. Die Suchleiste schlägt lokale Restaurants/POIs vor und kann Adressen gezielt ansteuern. POI-Popups bleiben offen, Detailbereiche sind einklappbar und ihre Zustände werden gemerkt. Place und eigene Rezension teilen sich eine Bewertung von 0,1 bis 10,0; komplette Sammlungen mit Orten, Bewertungen und Entwürfen werden skalierbar lokal importiert und exportiert. Einstellungen und Auswahlen bleiben beim nächsten App-Start erhalten; Google-Bewertungen werden nur bei hinterlegtem Google-API-Schlüssel eingeblendet.

<p align="center">
<a href="downloads/SHA256SUMS-2.3.20.txt"><strong>SHA-256</strong></a>
&nbsp; · &nbsp;
...
Build 55 behandelt die frühere WebSim-Ausgabe als Suchvertrag: alle benannten Gastro-Orte im Kartenausschnitt bleiben als neutrale Orte sichtbar; Pizza-/Italien-Signale werden zusätzlich präzise markiert.
