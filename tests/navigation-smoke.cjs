...
(async()=>{
 ...
 console.log(`PASS ${version} packaged UI: broad 10 km restaurant baseline plus additive pizza discovery with zero rating threshold, saved 4.6 slider, three Android portal links, active mocked Google Reviews fetch/privacy, compact navigation, five languages`);
