...
(async()=>{
 ...
 console.log(`PASS ${version} packaged UI: viewport-driven broad restaurant results plus additive PizzaScan discovery, automatic map regeneration, zero rating threshold, saved 4.6 slider, three Android portal links, active mocked Google Reviews fetch/privacy, compact navigation, five languages`);
