...
(async()=>{
 ...
 console.log(`PASS ${version} packaged UI: visible rating shortcut, saved 4.6 slider, three Android portal links, active mocked Google Reviews fetch/privacy, compact navigation, five languages`);
