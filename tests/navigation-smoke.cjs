...
(async()=>{
 ...
 console.log(`PASS ${version} packaged UI: viewport-based Pizza/Italian discovery, automatic map regeneration, zero rating threshold, saved 4.6 slider, three Android portal links, active mocked Google Reviews fetch/privacy, compact navigation, five languages`);
