...
test('Build 54 version and WebSim-complete mode',()=>{
  assert.equal(B.VERSION,'2.3.19');
  assert.equal(B.BUILD,54);
...
test('Build 54 always searches the visible map bbox like WebSim',()=>{
...
test('Build 54 keeps the WebSim selector families and restores named Italian venues',()=>{
...
test('Build 54 restores viewport auto-search without erasing unrelated filter choices',()=>{
...
test('Build 54 locks the coverage-complete query against legacy runtime reassignment',()=>{
