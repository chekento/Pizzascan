...
test('Build 57 version and WebSim-complete mode',()=>{
  assert.equal(B.VERSION,'2.3.22');
  assert.equal(B.BUILD,57);
...
test('Build 57 always searches the visible map bbox like WebSim',()=>{
...
test('Build 57 keeps the WebSim selector families and restores named Italian venues',()=>{
...
test('Build 57 restores viewport auto-search without erasing unrelated filter choices',()=>{
...
test('Build 57 locks the coverage-complete query against legacy runtime reassignment',()=>{
