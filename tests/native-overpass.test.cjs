...
test('packaged Android user agent switches Overpass JSON to the native bridge',async()=>{
 let called=null,webCalls=0;
 const root={
  navigator:{userAgent:'Mozilla/5.0 PizzaScan/2.3.3 (+https://github.com/chekento/Pizzascan)'},
  PizzaScanNative:{},
  ...
  placeService:{json:async()=>{webCalls++;return {elements:[]};}}
 };
