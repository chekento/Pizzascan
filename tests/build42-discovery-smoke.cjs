...
(async()=>{
 ...
 try{
  ...
  assert.equal(state.radius,0,'Build 57 must use the visible viewport like source-original WebSim');
  ...
  console.log('PASS Build 57 browser discovery: complete BBOX selectors, provider failover, modern controls');
